Shader "Toon Water"
{
    Properties
    {
        ...
        _DamagedDepthGradientShallow("Damaged Shallow", Color) = (0.85, 0.15, 0.15, 0.725)
        _DamagedDepthGradientDeep("Damaged Deep", Color)       = (0.25, 0.02, 0.02, 0.749)
        _DamagedFoamColor("Damaged Foam", Color)               = (1, 0.6, 0.6, 1)
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float  _TowerHealth01;
            float4 _DamagedDepthGradientShallow, _DamagedDepthGradientDeep, _DamagedFoamColor;
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float4 deepCol    = lerp(_DamagedDepthGradientDeep,    _DepthGradientDeep,    t);
                float4 foamMix    = lerp(_DamagedFoamColor,            _FoamColor,            t);

                // Depth-based water color using the blended palette
                float4 waterColor = lerp(shallowCol, deepCol, waterDepth01);
